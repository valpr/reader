...
- **Replication Save Behavior:** Resolves conflicts when both local and remote files have been modified:
  - **Overwrite:** Automatically overwrites with the newest version.
  - **Prompt:** Displays a conflict resolution dialog allowing you to choose whether to keep local or remote data.
